...
def main():
    ...
    time_ms = int(sys.argv[3]) #time that the laser is on and data is registered in miliseconds
    group_us = float(sys.argv[4])*500*10e-6
...
#Save the figure at the end with the runtime variable in the filename
    ...
    plt.savefig(f'{plot_saving_address}{file_name}_{group_us}_msgroup_{time_s}s'+f'_trial_{trial}.png')
